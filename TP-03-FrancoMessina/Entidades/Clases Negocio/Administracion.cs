...
namespace Entidades
{
    public class Administracion
    {
        ...
        /// </summary>
        /// <param name="clientes">Administracion donde se encuentra la lista de clientes</param>
        /// <param name="cliente">Cliente al que se le va a eliminar un servicio</param>
        /// <param name="servicio">Servicio que se va a eliminar</param>
        /// <returns>Retornará un string con mensaje dependiendo el caso</returns>
